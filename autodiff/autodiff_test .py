...
if __name__ == "__main__":
    ...
    test_identity()
    print("%-10s%10s" % ("Test 1 ", "Accepted"))
    test_add_by_const()
    print("%-10s%10s" % ("Test 2 ", "Accepted"))
    test_sub_by_const()
    print("%-10s%10s" % ("Test 3 ", "Accepted"))
    test_neg()
    print("%-10s%10s" % ("Test 4 ", "Accepted"))
    test_mul_by_const()
    print("%-10s%10s" % ("Test 5 ", "Accepted"))
    test_div_two_vars()
    print("%-10s%10s" % ("Test 6 ", "Accepted"))
    test_div_by_const()
    print("%-10s%10s" % ("Test 7 ", "Accepted"))
    test_add_two_vars()
    print("%-10s%10s" % ("Test 8 ", "Accepted"))
    test_mul_two_vars()
    print("%-10s%10s" % ("Test 9 ", "Accepted"))
    test_add_mul_mix_1()
    print("%-10s%10s" % ("Test 10 ", "Accepted"))
    test_add_mul_mix_2()
    print("%-10s%10s" % ("Test 11 ", "Accepted"))
    test_add_mul_mix_3()
    print("%-10s%10s" % ("Test 12 ", "Accepted"))
    test_grad_of_grad()
    print("%-10s%10s" % ("Test 13 ", "Accepted"))
    test_matmul_two_vars()
    print("%-10s%10s" % ("Test 14 ", "Accepted"))
    test_log_op()
    print("%-10s%10s" % ("Test 15 ", "Accepted"))
    test_log_two_vars()
    print("%-10s%10s" % ("Test 16 ", "Accepted"))
    test_exp_op()
    print("%-10s%10s" % ("Test 17 ", "Accepted"))
    test_exp_mix_op()
    print("%-10s%10s" % ("Test 18 ", "Accepted"))
    test_reduce_sum()
    print("%-10s%10s" % ("Test 19 ", "Accepted"))
    test_reduce_sum_mix()
    print("%-10s%10s" % ("Test 20 ", "Accepted"))
    test_mix_all()
    print("%-10s%10s" % ("Test 21 ", "Accepted"))
    test_logistic()
    print("%-10s%10s" % ("Test 22 ", "Accepted"))
    test_log_logistic()
    print("%-10s%10s" % ("Test 23 ", "Accepted"))
    test_logistic_loss()
    print("%-10s%10s" % ("Test 24 ", "Accepted"))
